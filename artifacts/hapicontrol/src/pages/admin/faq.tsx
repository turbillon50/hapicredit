...
function IconToggle({ active }: { active: boolean }) {
  return (
    <div style={{
      ...
      background: active ? "#e84545" : "#cbd5e1",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, padding: "16px 16px 40px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button
            ...
            style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 12, background: "#e84545", color: "#fff", border: "none", cursor: "pointer", fontWeight: 700, fontSize: 13 }}
          >
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="pressable"
                    style={{ flex: 2, padding: "13px", borderRadius: 14, border: "none", background: "#e84545", color: "#fff", fontWeight: 700, fontSize: 14, cursor: "pointer", opacity: isSaving ? 0.7 : 1 }}
                  >
