    ...
    <div style={{ minHeight: "100dvh", background: "#f8fafc", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 20px 64px" }}>
        ...
        <div style={s.section}>
          ...
          <p style={s.p}>
            <strong>Grupo CAFJA</strong> (en adelante "HapiCredit"), con domicilio en
            Ignacio Lopez Rayon Sur 702, Despacho 104, Col. Cuauhtemoc,
            Toluca, Estado de Mexico, es responsable del tratamiento de sus datos
            personales conforme a la Ley Federal de Proteccion de Datos Personales
            en Posesion de los Particulares (LFPDPPP).
          </p>
          <div style={{
            ...
            <p style={{ ...s.p, margin: 0 }}>
              <strong>Correo:</strong> GrupoCafja@gmail.com<br />
        ...
        <div style={s.section}>
          ...
          <p style={s.p}>
            En HapiCredit protegemos la informacion de nuestros clientes.
          ...
          <ul style={s.ul}>
            ...
            <li style={s.li}><strong>Referencias:</strong> Datos de referencias personales y del aval.</li>
          </ul>
          <p style={s.p}>
