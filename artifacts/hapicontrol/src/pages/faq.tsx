  ...
  return (
    <div
      style={{
        ...
        border: `1.5px solid ${open ? "#e84545" : "#e2e8f0"}`,
        overflow: "hidden",
    ...
    >
      ...
      >
        ...
        <span style={{ color: open ? "#e84545" : "#94a3b8", flexShrink: 0 }}>
  ...
  return (
    <Layout>
      <div style={{ display: "flex", flexDirection: "column", gap: 20, padding: "16px 16px 40px" }}>
          ...
          <div style={{ display: "flex", gap: 8, overflowX: "auto", paddingBottom: 2 }}>
            <button
              ...
              style={{
                padding: "7px 14px",
                borderRadius: 50,
                border: `1.5px solid ${!activeCategory ? "#e84545" : "#e2e8f0"}`,
                background: !activeCategory ? "#e84545" : "#f8fafc",
            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  padding: "7px 14px",
                  borderRadius: 50,
                  border: `1.5px solid ${activeCategory === cat ? "#e84545" : "#e2e8f0"}`,
                  background: activeCategory === cat ? "#e84545" : "#f8fafc",
        ...
        <div style={{
          borderRadius: 18,
          background: "linear-gradient(135deg,#142246 0%,#1e3a6e 100%)",
          padding: "18px 20px",
          display: "flex",
          ...
          <div style={{ display: "flex", gap: 8, marginTop: 4 }}>
            <a
              href="mailto:hapicredit@gmail.com"
              style={{
