...
function Header() {
  ...
  return (
    <header style={{
      background: "#142246", padding: "16px 24px",
...
const s: Record<string, React.CSSProperties> = {
  ...
  h2: { fontSize: 17, fontWeight: 800, color: "#142246", marginBottom: 10 },
  ...
  return (
    <div style={{ minHeight: "100dvh", background: "#f8fafc", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "32px 20px 64px" }}>
        ...
        {/* Hero */}
        <div style={{
          background: "linear-gradient(135deg, #142246, #1e3a6e)",
        ...
        <div style={s.section}>
          ...
          <p style={s.p}>
            Al solicitar un credito con <strong>HapiCredit</strong> (operado por
            <strong> Grupo CAFJA</strong>), el cliente acepta expresamente los presentes
            Terminos y Condiciones. Si no esta de acuerdo con alguno de ellos, debe
        ...
        <div style={s.section}>
          ...
          <p style={s.p}>
            HapiCredit es una plataforma de gestion de microcreditos personales que opera
        ...
        <div style={s.section}>
          ...
          <ul style={s.ul}>
            ...
            <li style={s.li}>HapiCredit podra realizar <strong>validaciones de informacion y visitas domiciliarias</strong>.</li>
        ...
        <div style={s.section}>
          ...
          <p style={s.p}>
            HapiCredit se reserva el derecho de modificar estos Terminos en cualquier
        ...
        <div style={s.section}>
          ...
          <InfoBox>
            <strong>Grupo CAFJA — HapiCredit</strong><br />
            ...
            Correo: <strong>GrupoCafja@gmail.com</strong><br />
        ...
        <div style={{ borderTop: "1px solid #e5e7eb", paddingTop: 24, textAlign: "center" }}>
          <p style={{ fontSize: 12, color: "#9ca3af" }}>
            Grupo CAFJA — HapiCredit — hapicredit.live
          </p>
          <p style={{ fontSize: 12, color: "#9ca3af" }}>
            Al utilizar HapiCredit, usted confirma haber leido y aceptado estos Terminos y Condiciones.
          </p>
        </div>
      </div>
    </div>
