        ...
        <div className="px-4">
          ...
          <div className="card flex flex-col gap-3">
            ...
            {activeCredit && (
              ...
              >
                <div className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0" style={{ background: "var(--surface-3)" }}>
                  <IconCalendario size={16} color="var(--success)" />
                </div>
                <div>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460 }}>
            ...
            <p style={{ fontSize: 13, color: "var(--text-secondary)", margin: "0 0 16px" }}>
              ...
              <span style={{ color: "var(--danger)", fontSize: 12 }}>Esto recalculara las fechas de todos los pagos del crédito activo.</span>
            </p>
      ...
      {showEditCond && activeCredit && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460, maxHeight: "90vh", overflowY: "auto" }}>
            ...
            {editCondMut.isError && (
              <div style={{ fontSize: 12, color: "var(--danger)", marginBottom: 10, textAlign: "center" }}>{(editCondMut.error as Error).message}</div>
            )}
            <button
