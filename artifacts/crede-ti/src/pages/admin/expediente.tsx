        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460, maxHeight: "80vh", overflowY: "auto" }}>
            ...
            <button
              ...
              style={{ width: "100%", padding: 14, background: "#2A3CD6", color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 15, cursor: (!newExecId || reasignarMut.isPending) ? "default" : "pointer", marginBottom: 10, opacity: (!newExecId || reasignarMut.isPending) ? 0.5 : 1, fontFamily: "inherit" }}
            >
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460 }}>
            ...
            <button
              ...
              style={{ width: "100%", padding: 14, background: "#2A3CD6", color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 15, cursor: (!newDate || cambiarFechaMut.isPending) ? "default" : "pointer", marginBottom: 10, opacity: (!newDate || cambiarFechaMut.isPending) ? 0.5 : 1, fontFamily: "inherit" }}
            >
