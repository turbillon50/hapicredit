...
const MEDAL = ["var(--warning)", "var(--text-muted)", "#b45309"];
        ...
        {!isLoading && ranking.length > 0 && (
          <div className="px-4 grid grid-cols-2 gap-3">
            ...
            <div className="card text-center">
              ...
              <div className="text-lg font-extrabold" style={{ color: "var(--success)" }}>{fmt(totalCommission)}</div>
                  ...
                  <div key={exec.executiveId} className="card">
                    ...
                    <div className="grid grid-cols-3 gap-2 pt-3 border-t border-gray-100">
                      ...
                      <div className="text-center border-x border-gray-100">
                        ...
                        <div className="text-sm font-bold" style={{ color: "var(--success)" }}>{fmt(commission)}</div>
                      </div>
                      <div className="text-center">
                        <div className="text-[10px] font-semibold uppercase text-gray-400 mb-0.5">Cumplimiento</div>
                        <div className="text-sm font-bold" style={{ color: pct >= 80 ? "var(--success)" : pct >= 50 ? "var(--warning)" : "var(--danger)" }}>
                          {pct.toFixed(0)}%
                        </div>
                      </div>
                    </div>
