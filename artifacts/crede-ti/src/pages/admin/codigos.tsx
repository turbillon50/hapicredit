              ...
              {pendingCodes.map(c => (
                <div key={c.id} style={{ background: "white", borderRadius: 14, padding: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)", border: "1.5px solid #f1f5f9" }}>
                  ...
                  <div style={{ display: "flex", gap: 8 }}>
                    <button onClick={() => copyCode(c.code)} style={{ flex: 1, padding: "9px", border: "1.5px solid #e2e8f0", borderRadius: 8, background: copied === c.code ? "var(--surface-3)" : "white", color: copied === c.code ? "#166534" : "#374151", fontWeight: 600, fontSize: 12, cursor: "pointer" }}>
