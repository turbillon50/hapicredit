    ...
    <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
      <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460 }}>
        ...
        <button
          ...
          style={{ width: "100%", padding: "14px", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 15, cursor: loading ? "default" : "pointer", background: "#0E68CC", color: "#fff", fontFamily: "inherit", marginBottom: 10, opacity: loading ? 0.6 : 1 }}
        >
    ...
    <Layout>
      <div style={{ padding: "16px 16px 100px" }}>
        <div style={{ marginBottom: 20 }}>
          <h1 style={{ fontSize: 20, fontWeight: 800, color: "#0E68CC" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 10, marginBottom: 20 }}>
          <div style={{ background: "white", borderRadius: 12, padding: "12px", textAlign: "center", border: "1px solid #f1f5f9" }}>
            <div style={{ fontSize: 22, fontWeight: 800, color: "#0E68CC" }}>{totalAll}</div>
        ...
        {!isLoading && !error && level1.length === 0 && (
          <div style={{ textAlign: "center", marginTop: 50, padding: "0 8px" }}>
            ...
            <a
              href="/perfil"
              style={{ display: "inline-block", padding: "13px 28px", background: "#0E68CC", color: "#fff", borderRadius: 14, fontSize: 14, fontWeight: 700, textDecoration: "none" }}
            >
        ...
        {!isLoading && !error && level1.length > 0 && (
          <>
            <div style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, background: "#0E68CC", borderRadius: 14, padding: "14px 16px" }}>
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.5)", zIndex: 1000, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
          <div style={{ background: "#fff", borderRadius: "24px 24px 0 0", padding: "28px 24px 40px", width: "100%", maxWidth: 460, maxHeight: "80vh", overflowY: "auto" }}>
            ...
            <button
              ...
              style={{ width: "100%", padding: 14, background: "#0E68CC", color: "white", border: "none", borderRadius: 14, fontWeight: 700, fontSize: 15, cursor: (!newParentId || cambiarSucursalMut.isPending) ? "default" : "pointer", marginBottom: 10, opacity: (!newParentId || cambiarSucursalMut.isPending) ? 0.5 : 1, fontFamily: "inherit" }}
            >
