...
function IconToggle({ active }: { active: boolean }) {
  return (
    <div style={{
      ...
      background: active ? "#2A3CD6" : "#cbd5e1",
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 16, padding: "16px 16px 40px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <button
            ...
            style={{ display: "flex", alignItems: "center", gap: 6, padding: "8px 14px", borderRadius: 12, background: "#2A3CD6", color: "#fff", border: "none", cursor: "pointer", fontWeight: 700, fontSize: 13 }}
          >
            ...
            {(items as FaqItem[]).map(item => (
              <div
                ...
                style={{
                  borderRadius: 16,
                  background: "#fff",
                  border: `1.5px solid ${item.isActive ? "#e2e8f0" : "#fecaca"}`,
                  padding: "14px 14px",
                }}
              >
                <div style={{ display: "flex", alignItems: "flex-start", gap: 10 }}>
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <div style={{ fontSize: 12, color: "#94a3b8", display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
                      ...
                      {!item.isActive && <span style={{ background: "#fef2f2", color: "#dc2626", borderRadius: 6, padding: "2px 7px", fontWeight: 600 }}>Inactiva</span>}
                    </div>
                  </div>
                  <div style={{ display: "flex", gap: 6, flexShrink: 0 }}>
                    ...
                    <button
                      ...
                      style={{ width: 32, height: 32, borderRadius: 10, background: "#eff6ff", border: "none", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", color: "#2563eb" }}
                    >
                      <IconEdit />
                    </button>
                    <button
              ...
              <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                ...
                <div style={{ display: "flex", gap: 10, marginTop: 4 }}>
                  ...
                  <button
                    ...
                    disabled={isSaving}
                    className="pressable"
                    style={{ flex: 2, padding: "13px", borderRadius: 14, border: "none", background: "#2A3CD6", color: "#fff", fontWeight: 700, fontSize: 14, cursor: "pointer", opacity: isSaving ? 0.7 : 1 }}
                  >
