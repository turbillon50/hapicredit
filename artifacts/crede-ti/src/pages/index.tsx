    ...
    <div className="min-h-[100dvh] bg-white flex flex-col">
        ...
        <section className="px-5 py-16 md:py-24 max-w-5xl mx-auto">
          <div className="max-w-2xl">
            ...
            <p className="text-[16px] text-muted-foreground leading-relaxed mt-4 max-w-xl">
              Crede-Ti centraliza la gestión de tus microcréditos: clientes, pagos, cobranza y análisis financiero — todo desde tu celular.
            </p>
      ...
      <footer className="border-t border-border py-6 text-center bg-white">
        <p className="text-[11px] text-muted-foreground">
          &copy; {new Date().getFullYear()} Crede-Ti — Todos los derechos reservados
        </p>
      </footer>
    </div>
  );
