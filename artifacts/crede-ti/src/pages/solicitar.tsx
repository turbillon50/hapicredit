      ...
      <Layout>
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-5 py-10 text-center">
          <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center mx-auto mb-5">
            <IconDobleCheck size={36} color="var(--success)" />
          </div>
          ...
          <div className="rounded-2xl p-4 mb-4 w-full max-w-xs" style={{ background: "var(--surface-3)", border: "1.5px solid var(--surface-3)" }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            {error && (
              <div className="rounded-xl px-4 py-3 flex items-start gap-2" style={{ background: "#fff0f0", border: "1px solid var(--surface-3)" }}>
                <IconAlerta size={18} color="var(--danger)" />
