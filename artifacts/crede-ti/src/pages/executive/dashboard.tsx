        ...
        <div style={{ padding: "4px 16px 0" }} className="anim-section anim-d4">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              ...
              { href: "/dashboard/comisiones",    icon: <IconMoneda size={18} />,  iconBg: "var(--surface-3)",  iconColor: "var(--success)", title: "Mis comisiones",  sub: `Este mes: ${fmt(d?.commissionThisMonth ?? 0)}` },
