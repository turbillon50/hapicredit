...
export default function Registro() {
  ...
  function selectRole(r: Role) {
    ...
    if (r === "client") {
      ...
      localStorage.setItem("credeti_pending_role", r);
  ...
  async function validateStaffPass() {
    ...
    try {
      ...
      localStorage.setItem("credeti_pending_role",       role!);
      localStorage.setItem("credeti_pending_staff_pass", staffPass);
      localStorage.removeItem("credeti_pending_code");
      window.location.href = `${basePath}/sign-up`;
    } catch {
        ...
        {(inviteValid === null || inviteValid === false) && step === 1 && (
          <div style={{ padding: "28px 22px" }}>
            <div style={{ marginBottom: 20 }}>
              <div style={{ fontSize: 18, fontWeight: 800, color: "#111", letterSpacing: "-0.03em" }}>¿Cómo vas a usar Crede-Ti?</div>
